...
[WARNING]
====
*DEPRECATED:* This workflow is now legacy and deprecated. Please use link:https://github.com/cloudbees-io/snyk-sast-plugin[snyk-sast-plugin] instead. This legacy workflow will be retired on September 30th, 2026.
====
